...
- Added the standalone `hindsight-agent-bridge` release assets for Codex and Grok, with shared OMP memory scoping, lifecycle hooks, MCP tools, embedded skill policy, and project observation scopes.
